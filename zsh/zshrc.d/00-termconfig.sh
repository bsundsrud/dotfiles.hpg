# Adapted from Manjaro Linux's zsh defaults
...
source $cur_dir/plugins/zsh-syntax-highlighting/zsh-syntax-highlighting.zsh
# Use history substring search
source $cur_dir/plugins/zsh-history-substring-search/zsh-history-substring-search.zsh
